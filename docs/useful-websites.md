...
- [icons8 - 500 free animated icons](https://icons8.com/free-animated-icons)

- [Fontpair (pairing ideas)](https://www.fontpair.co/)
...
- [Canva (templates from slides to business cards)](https://www.canva.com/)
...
- [Design Seeds - nature photos alongside their color palettes](https://www.design-seeds.com/)

- [Colormind (great with Bootstrap or other HTML / CSS frameworks)](http://colormind.io/)

## Tools

### Must-haves

- [Google Analytics (track traffic)](https://analytics.google.com/)

- [Google Lighthouse (analyze performance metrics)](https://github.com/GoogleChrome/lighthouse)
...
- [Google keyword planner](https://ads.google.com/intl/de_de/home/tools/keyword-planner/)
...
- [Keyword ideas / research](https://www.keyword-tools.org/)
...
- [Grammarly (spell checker - free "version")](https://app.grammarly.com/) and [online editor](https://demo.grammarly.com/)
...
- [Heroku (use pipeline combined with Terraform)](https://www.heroku.com/)
